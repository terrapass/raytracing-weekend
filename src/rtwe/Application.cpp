...
{
    return {
        {std::make_shared<PlaneRayTarget>(Vector3(0.0f, -0.5f, 0.0f), Vector3(0.0f, 1.0f, 0.0f)), Material{Color(0.75f, 0.75f, 0.75f), false,  0.0f}},
        {std::make_shared<SphereRayTarget>(Vector3(0.0f, 0.0f, 1.0f), 0.5f),                      Material{Color(0.95f, 0.5f,  0.5f),  false,  0.85f}},
        {std::make_shared<SphereRayTarget>(Vector3(0.75f, -0.25f, 0.75f), 0.25f),                 Material{Color(0.35f, 0.7f, 0.35f),  true,   0.25f}},
        {std::make_shared<SphereRayTarget>(Vector3(-1.25f, 0.25f, 1.5f), 0.75f),                  Material{Color(0.9f, 0.8f, 0.2f),    true,   0.95f}}
    };
}
